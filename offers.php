  ...
  <body>
    ...
    <main role="main" class="container-fluid">  
      ...
      <div class="text-center">
        ...
        <p>Фотодень - это день, когда мы снимаем актерское портфолио для небольшой группы актеров, поэтому в этот день мы можем позволить себе сделать цену максимально дешевой!</p>
        ...
        <h2>МОСКВА: 8-12 ФЕВРАЛЯ</h2>
        <h2>САНКТ-ПЕТЕРБУРГ: 15-19 ФЕВРАЛЯ</h2>
        ...
        <p>Первым 10, кто забронирует даты, до 20 января - в подарок персональный программа продвижения в социальных сетях, на основе анализа твоей страницы ;)</p>
