...
<html lang="ru">
  ...
  <body>
    ...
    <main role="main" class="container-fluid">
      ...
      <h4 class="text-center">ПАКЕТЫ НА ФОТОСЪЁМКУ (АКТЁРСКОЕ ПОРТФОЛИО & МОДЕЛЬНЫЕ ТЕСТЫ)</h4>
        ...
        <div class="col-sm-6">
          ...
          <div class="bordered-div d-flex flex-column">
            ...
            <ul>
              ...
              <li>Реквизит под съёмку</li>
              <li>Работа визажиста: 1 час</li>
              <li>Консультация стилиста: 3 образа</li>            
              <li>Свет для видеосъёмки и фотосъёмки</li>
              <li>Срок готовности: 14 дней</li>            
            </ul>
            Вы получаете
            <ul>
              <li>Видео - до 2-х минут в качестве FullHD</li>
