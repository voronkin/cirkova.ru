...
function MailSmtp($reciever, $subject, $content, $headers, $debug = 0) {
  ...
  $smtp_server = 'smtp.metwodotzero.ru'; // адрес SMTP-сервера
  $smtp_port = 25; // порт SMTP-сервера
  $smtp_user = 'info@metwodotzero.ru'; // Имя пользователя для авторизации на SMTP-сервере
  $smtp_password = 'cIxFaRyGm'; // Пароль для авторизации на SMTP-сервере
  $mail_from = 'info@metwodotzero.ru'; // Ящик, с которого отправляется письмо
